...
public class TwitchOAuth : MonoBehaviour
{
    ...
    [SerializeField] private TMP_InputField uiTextToken = null;
    [SerializeField] private TwitchIntegrationDemo td = null;
    ...
    private void StartLocalWebserver()
    {
        ...
        {   
            httpListener.Stop();
            #if UNITY_EDITOR
            Debug.LogWarning("이미 Local Web Server가 실행중입니다.");
            #endif
        }
    }
